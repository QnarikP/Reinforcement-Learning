...
class Maze:
    ...
    By default, it's initialized to DynaMaze. However, it can be easily adapted to another maze.
    """
    # endregion Summary
    ...
    def __init__(self):
        ...
        # expose old-style constants for backward compatibility
        ...
        # initial state action pair values (use world dimensions)
        self.q_size = (self.WORLD_HEIGHT, self.WORLD_WIDTH, len(self.actions))
        self.stateActionValues = np.zeros(self.q_size)
    ...
    def extend_state(self, state, factor):
        ...
        :param state: State in a lower resolution maze
    ...
    def extend_maze(self, factor):
        ...
        # update backward-compatible attributes
        new_maze.WORLD_WIDTH = new_maze.world["width"]
        new_maze.WORLD_HEIGHT = new_maze.world["height"]
        ...
        # set q_size and initial stateActionValues for the new maze
        new_maze.q_size = (new_maze.WORLD_HEIGHT, new_maze.WORLD_WIDTH, len(new_maze.actions))
        new_maze.stateActionValues = np.zeros(new_maze.q_size)
