...
class Bandit:
    ...
    def act(self):
        ...
        # UCB action selection: select among the non-greedy actions according to their potential for actually being optimal, taking into account both how close their estimates are to being maximal and the uncertainties in those estimates.
        ...
        # GBA action selection: learn a numerical preference for each action (denoted as 𝐻_𝑡(𝑎)).
        ...
        # Action probabilities are determined according to a soft-max distribution (i.e., Gibbs or Boltzmann distribution).
        if self.use_gradient:
            # Estimated action values can be used as numerical preference for each action because 𝑄_𝑡(𝑎) ∈ 𝑅 and 𝑄_1(𝑎) = 0
